...
| 子任务 | 产出物 | 状态 |
|--------|--------|------|
| T05-1 撰写产品标题和一句话简介（突出"5个AI员工"概念） | 标题+简介文案 | ⬜ |
| T05-2 撰写产品详细描述（目标用户、核心卖点、使用场景、定价） | 长描述文案 | ⬜ |
| T05-3 设计产品宣传图（1页介绍图，用AI生图） | 宣传图.png | ⬜ |
| T05-4 编写短视频脚本（30~60秒产品介绍） | 视频脚本.md | ⬜ |
| T05-5 更新SkillHub SKILL.md描述和触发词 | SKILL.md更新 | ⬜ |
